...
| 단계 | 사용자가 확인하는 것 |
|---|---|
| 대화·자료 | 대화 검색/휴지통, 대화별·프로젝트 공용 참고자료, 저장된 대화 맥락 |
...
**검증한 범위:** 개발 Mac의 브라우저 회귀 87개 통과/3개 해당 없음, 종료 직전 협업 편집 보존 검사 15개 통과, 새 DB를 사용한 실제 통합 복원 검사 2회 통과.
이는 모든 AI 응답의 정확도나 다른 컴퓨터에서의 무설정 실행을 보장하지 않습니다. [검증 기록과 한계](docs/20-stage4-local-operations.md)를 함께 공개합니다.
